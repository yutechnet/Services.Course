...
Scenario: Create a basic program
	...
	| Bachelor's of Science | Economics   | MA          | E2DF063D-E2A1-4F83-9BE0-218EC676C05F | 1      |
...
Scenario: Modify a program
	Given I have a program with following info:
	| Name                  | Description | ProgramType | OrganizationId | Tenant |
	| Bachelor's of Science | Economics   | BA          | E2DF063D-E2A1-4F83-9BE0-218EC676C05F | 1      |
	When I submit a request to create a program
	And I modify the program info to reflect the following:
	| Name              | Description | ProgramType | OrganizationId | Tenant |
	| Bachelor's of Art | English     | BA          | E2DF063D-E2A1-4F83-9BE0-218EC676C05F | 1      |
...
Scenario: Get all programs
	Given I have a program with following info:
	| Name                  | Description | ProgramType | OrganizationId | Tenant |
	| Bachelor's of Science | Economics   | AA          | E2DF063D-E2A1-4F83-9BE0-218EC676C05F | 1      |
	When I submit a request to create a program
	And I submit another request to create another program
	| Name              | Description | ProgramType | OrganizationId | Tenant |
	| Bachelor's of Art | Philosophy  | AA          | E2DF063D-E2A1-4F83-9BE0-218EC676C05F | 1      |
