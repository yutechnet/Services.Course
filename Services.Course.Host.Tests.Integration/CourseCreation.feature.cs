...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("English 101", "ENGL101", "Learn to read and write", "1", null)]
        [NUnit.Framework.TestCaseAttribute("Engineering 200", "ENG200", "If you build it, they will come", "1", null)]
        [NUnit.Framework.TestCaseAttribute("English 220", "ENGL220", "Essays", "1", null)]
        [NUnit.Framework.TestCaseAttribute("Philosophy 100", "PHIL100", "To be, or not to be", "1", null)]
        [NUnit.Framework.TestCaseAttribute("Philanthropy 101", "PHILA101", "Don\'t be greedy", "1", null)]
        [NUnit.Framework.TestCaseAttribute("Chemistry 350", "CHEM350", "Periodic table of elements to the max", "1", null)]
        public virtual void ReturnCourseByPartialName(string name, string code, string description, string tenantId, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Return course by partial name", exampleTags);
#line 81
this.ScenarioSetup(scenarioInfo);
#line 82
 testRunner.When(string.Format("I create a new course with {0}, {1}, {2}", name, code, description), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
