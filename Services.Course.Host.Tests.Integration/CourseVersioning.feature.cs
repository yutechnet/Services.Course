...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Create a course version from a previously-published version with prerequisites", new string[] {
                        "ignore"});
#line 88
this.ScenarioSetup(scenarioInfo);
#line 7
