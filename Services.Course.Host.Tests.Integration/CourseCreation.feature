...
Scenario: Return course by partial name
	Given I have existing courses with following info:
		 | Name             | Code     | Description                           |
		 | English 101      | ENGL101  | Learn to read and write               |
		 | Engineering 200  | ENG200   | If you build it, they will come       |
		 | English 220      | ENGL220  | Essays                                |
		 | Philosophy 100   | PHIL100  | To be, or not to be                   |
		 | Philanthropy 101 | PHILA101 | Don't be greedy                       |
		 | Chemistry 350    | CHEM350  | Periodic table of elements to the max |
